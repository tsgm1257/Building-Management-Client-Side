// src/pages/dashboard/admin/ManageCoupons.jsx
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { useContext, useState } from "react";
import { AuthContext } from "../../../providers/AuthProvider";
import { FaToggleOn, FaToggleOff, FaTags } from "react-icons/fa";
  ...
  return (
    <Container className="py-6">
      <div className="p-6">
        ...
        <div className="overflow-x-auto bg-base-100 rounded shadow border border-base-300">
